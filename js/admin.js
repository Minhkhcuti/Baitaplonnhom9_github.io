...
let products = JSON.parse(localStorage.getItem("products")) || [
    {
        id: 1, name: "Son Kem Lì 3CE Velvet Lip Tint",
        price: 320000, category: "Lipstick", stock: 25,
        image: "../images/products/son1.jpg"
    },
    {
        id: 2, name: "Son Dior Addict Lip Glow",
        price: 890000, category: "Lipstick", stock: 12,
        image: "../images/products/son2.jpg"
    },
    {
        id: 3, name: "Nước Hoa Nữ Chanel No.5",
        price: 2450000, category: "Perfume", stock: 8,
        image: "../images/products/nuochoa1.jpg"
    },
    {
        id: 4, name: "Nước Hoa Nữ Dior Miss Dior",
        price: 2650000, category: "Perfume", stock: 6,
        image: "../images/products/nuochoa2.jpg"
    },
    {
        id: 5, name: "Sữa Rửa Mặt CeraVe Foaming Cleanser",
        price: 280000, category: "Cleanser", stock: 20,
        image: "../images/products/srm2.jpg"
    },
    {
        id: 6, name: "Sữa Rửa Mặt Senka Perfect Whip",
        price: 150000, category: "Cleanser", stock: 30,
        image: "../images/products/srm1.jpg"
    },
    {
        id: 7, name: "Serum Glow Recipe Watermelon",
        price: 850000, category: "Serum", stock: 12,
        image: "../images/products/serum2.jpg"
    },
    {
        id: 8, name: "Anua Peach 70 Niacin Serum",
        price: 920000, category: "Serum", stock: 10,
...
if (productForm) {
    productForm.addEventListener("submit", function (e) {
        ...
        if (editingId !== null) {
            ...
            if (idx !== -1) {
                products[idx] = { ...products[idx], name, price, category, stock, image };
            }
        } else {
            const newId = products.length > 0 ? Math.max(...products.map(p => p.id)) + 1 : 1;
            products.push({ id: newId, name, price, category, stock, image });
        }
